<div style="display: grid; gap: 1rem;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(12rem, 1fr)); gap: 1rem;">
        <div class="fi-section" style="padding: 1.25rem; text-align: center;">
            <strong style="display: block; font-size: 1.5rem;"><?php echo e(number_format($totalStudents, 0, ',', '.')); ?></strong>
...
<?php /**PATH C:\laragon\www\yayasan-app\resources\views/filament/admin/resources/student-enrollments/summary.blade.php ENDPATH**/ ?>